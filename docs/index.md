...
- [Getting Started — hardware setup, structured workflow, and local semantic de-identification](getting-started.md)
...
- [Privacy profiles](privacy-profiles.md)
- [Organization policy files](organization-policy.md)
